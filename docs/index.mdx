...
<Frame caption="Every overlay, toggled live in the example app's Playground">
  <video autoPlay loop muted playsInline controls poster="https://github.com/brandtnewlabs/react-native-livechart/releases/download/media/001-playground.jpg" src="https://github.com/brandtnewlabs/react-native-livechart/releases/download/media/001-playground.mp4" />
</Frame>
