...
<CardGroup cols={2}>
  ...
  <Card title="Phantom · Up/Down" icon="timer" href="https://github.com/brandtnewlabs/react-native-livechart/blob/main/app/showcase/phantom-up-down.tsx">
    Five-minute SOL prediction market — a live round target with timeframe morphs.
  </Card>
