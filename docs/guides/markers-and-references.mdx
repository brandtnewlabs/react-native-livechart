...
<Frame caption="Trade-fill markers and a scrolling buy/sell stream">
  <video autoPlay loop muted playsInline controls poster="https://github.com/brandtnewlabs/react-native-livechart/releases/download/media/008-markers-trades.jpg" src="https://github.com/brandtnewlabs/react-native-livechart/releases/download/media/008-markers-trades.mp4" />
</Frame>
...
<Frame caption="Reference lines, bands, and off-axis badges">
  <video autoPlay loop muted playsInline controls poster="https://github.com/brandtnewlabs/react-native-livechart/releases/download/media/009-reference-lines-bands.jpg" src="https://github.com/brandtnewlabs/react-native-livechart/releases/download/media/009-reference-lines-bands.mp4" />
</Frame>
