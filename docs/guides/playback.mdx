...
<Frame caption="Pause, scrub the time window, and replay a recorded session">
  <video autoPlay loop muted playsInline controls poster="https://github.com/brandtnewlabs/react-native-livechart/releases/download/media/012-playback.jpg" src="https://github.com/brandtnewlabs/react-native-livechart/releases/download/media/012-playback.mp4" />
</Frame>
