...
<Frame caption="Light/dark themes and an accent-driven palette">
  <video autoPlay loop muted playsInline controls poster="https://github.com/brandtnewlabs/react-native-livechart/releases/download/media/010-theming.jpg" src="https://github.com/brandtnewlabs/react-native-livechart/releases/download/media/010-theming.mp4" />
</Frame>
