...
<Frame caption="Candlestick mode with a live, forming candle">
  <video autoPlay loop muted playsInline controls poster="https://github.com/brandtnewlabs/react-native-livechart/releases/download/media/007-candlestick.jpg" src="https://github.com/brandtnewlabs/react-native-livechart/releases/download/media/007-candlestick.mp4" />
</Frame>
