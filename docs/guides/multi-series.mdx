...
<Frame caption="Multiple live series with a toggleable legend">
  <video autoPlay loop muted playsInline controls poster="https://github.com/brandtnewlabs/react-native-livechart/releases/download/media/005-multi-series.jpg" src="https://github.com/brandtnewlabs/react-native-livechart/releases/download/media/005-multi-series.mp4" />
</Frame>
