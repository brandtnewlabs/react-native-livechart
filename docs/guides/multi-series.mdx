...
The multiplier covers strokes, value lines, and inline value labels. It does not
dim axes, the legend, reference lines, or scrub UI. Live dots and pulse rings
fade completely out while the multiplier is below `1`, then fade back in after
