...
interface LineConfig {
  ...
  color?: string | SharedValue<string>; // line color override; defaults to palette
                    //   accent. A SharedValue animates the stroke on the UI thread;
                    //   selection dot, segment base, area-dot tint, and threshold
                    //   rest color then use the palette line color
